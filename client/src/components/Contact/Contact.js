...
const API = "http://localhost:7000/sendmail"
        ...
        <div className="row">
            <div className="col-xl-5 col-lg-5 col-md-5 col-sm-5">
               <div className="contact-form-img">
                <img src="https://img.freepik.com/free-photo/young-woman-working-laptop-with-win-gesture-posing-isolated-turquoise-wall_231208-11520.jpg?w=2000" alt="contact-img" />
                </div> 
            </div>
